...
//     $id_dt =  $_GET['id_don'];
//     $dattiec->datLai($id_dt);
//     echo '<script>alert("Đặt lại đơn thành công.");</script>';
...
if (isset($_GET['id_don'])) {
    echo $_GET['id_don'];
    $dattiecs = $dattiec->find($_GET['id_don']);
    $id_dv = $dattiecs->id_dv;
    $id_douong = $dattiecs->id_douong;
} else {
        ...
        <section id="inner" class="inner-section section">
            ...
            <div class="inner-wrapper row">
                ...
                ?>
                    ...
                    <?php
                    if (isset($id_douong)) {
                        $chitietdouong2 = $chitietdouong->finddouong($id_douong);
                        $douong2 = $douong_user->find($id_douong);
                    ...
                    ?>
                            <div class=" col-12">
                                <a class="btn btn-sm btn-primary" href="choose_drink.php?id_menu=<?php echo $id_menu; ?>&id_menu_douong=<?php echo $id_douong ?>&id_dv=<?php echo $id_dv ?>">Thêm Đồ Uống</a>
                    ...
                    <div class="col-md-12 card-container row ">
                        <div class="col-12 text-center">
                            <form id="dattiec" action="addtiec.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select require name="id_loaitiec" id="id_loaitiec" class="custom-select">
                                                    ...
                                                    ?>
                                                        <option value="<?php echo $loaitiec->getId() ?>" <?= $dattiecs->id_loaitiec == $loaitiec->getId() ? "selected" : "" ?>>
                                                            <?php
                                                            echo ($i++);
                                            ...
                                            <td><select require name="tinh" id="tinh" class="custom-select">
                                                    <option value="" hidden>--Chọn--</option>
                                                    <option value="" <?= $dattiecs->tinh ? "selected" : "" ?>>
                                                        <?php echo $dattiecs->tinh ?>
                                                    </option>
                                                </select></td>
                                        </tr>
                                        <tr>
                                ...
                                <input type="text" name="id_douong" value="<?php if (!isset($_GET['id_menu_douong']) || $chitietdouong2 == null) {
                                                                                echo "0";
                                                                            } else {

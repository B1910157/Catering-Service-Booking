...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    $monans = $monan->findMonDV($_GET['id_dv']);
    // echo $_GET['id_me'];
    $id_dv = $_GET['id_dv'];
    // $id_menu_user = $_GET['id_me'];
    $id_menu = $_GET['id_me'];
                ...
                ?>
                        <div class="card-item m-3">
                            ...
                            <div class="card-footer">
                                <button class="btn btn-primary" type="submit">>Thêm Vào Menu</button>
                            </div>
                        </div>
                    ...
                    ?>
                        <div class="card-item text-center m-3 border">
                            ...
                            <form action="addMonVaoMenu.php" method="post" enctype="multipart/form-data">

                                <input type="hidden" name="id_menu" value="<?php echo $id_menu; ?>">
                                <input hidden type="hidden" name="id" min="0" value="<?php echo $monan->getId(); ?>">
                                <div class="card-footer ">
